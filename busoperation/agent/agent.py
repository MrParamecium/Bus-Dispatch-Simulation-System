...
class Agent(ABC):
    ...
    def __init__(self, agent_config: Dict[str, Any]) -> None:
        ...
        self.bus_id_loc: Dict[str, float] = {}
        self.bus_id_speed: Dict[str, float] = {}
        # self.bus_id_pax_in_vehicle_time: Dict[str, int] = {}
        # self.bus_id_pax_out_vehicle_time: Dict[str, int] = {}
    ...
    def extrat_bus_info_from_snapshot(self,snapshot: Snapshot):

        for (route_id, bus_id), bus_snapshot in snapshot.bus_snapshots.items():
            self.bus_id_loc[bus_id] = bus_snapshot.loc_relative_to_terminal
            self.bus_id_speed[bus_id] = bus_snapshot.speed
            # self.bus_id_pax_in_vehicle_time[bus_id] = bus_snapshot.total_pas_in_vehicle_time
            # self.bus_id_pax_out_vehicle_time[bus_id] = bus_snapshot.total_pas_out_vehicle_time
            # self.bus_id_total_pas_num[bus_id] = bus_snapshot.total_pas_num