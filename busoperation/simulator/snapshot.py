...
class BusSnapshot:
    ...
    stop_link_speed: Dict[str, float]
...
class LinkSnapshot:
    ...
    link_id: str
    route_enter_time_seq: Dict[str, dict[str,float]]
    route_enter_bus_id_seq: Dict[str, List[str]]
    route_enter_speed_seq: Dict[str, dict[str,float]]
...
class HolderSnapshot:
    ...
    finished_holding_buses:List[Tuple[str, str, str]]
...
class Snapshot:
    ...
    link_snapshots: Dict[str, LinkSnapshot]
