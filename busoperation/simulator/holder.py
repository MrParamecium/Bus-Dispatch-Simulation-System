...
class Holder:
    ...
    def __init__(self, agent: Agent, virtual_bus: VirtualBus, has_schedule: bool) -> None:
        ...
        self.finished_hold_buses: List[Tuple[str, str, str]] = []
        ...
        for (stop_id, route_id, bus_id), hold_time in self._identifier_time.items():
            if hold_time is not None:
                ...
                if hold_time <= 0:
                    ...
                    self.finished_hold_buses.append((stop_id, route_id, bus_id))
    ...
    def take_snapshot(self) -> HolderSnapshot:
        ...
        if self._has_schedule:
            holder_snapshot = HolderSnapshot(unheld_buses,self.finished_hold_buses,self.holder_log.route_stop_departure_time_seq,
