...
from .pax import Pax
from .snapshot import Snapshot, StopSnapshot, BusSnapshot,LinkSnapshot
...
class Tracer:
    ...
    def take_snapshot(self, t: int, links: Dict[str, Link], stops: Dict[str, Stop], holder: Holder) -> Snapshot:
        ...
        for link in links.values():
            link_snapshots[link._link_id] =link.take_snapshot()
        ...
        snapshot = Snapshot(t, bus_snapshots, stop_snapshots,link_snapshots, holder_snapshot)
